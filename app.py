...
def main():
    try:
        ...
        # load the latents
        s1 = np.load(
            'latent_representations/975ef98316de0e2eebf2935b279df37479-27-donald-trump-thumbs-up.rsquare.w700_01.npy')
        s2 = np.load('latent_representations/IMG_2482_01_01.npy')
